      ...
      <div className="max-w-md w-full relative z-10 animate-fade-in">
        <div className="glass-dark rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 border border-white/20">
          ...
          <div className="text-center mb-6 sm:mb-8">
            <div className="gradient-primary w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg">
            ...
            <p className="text-white text-base sm:text-lg font-medium">Login to continue to EventMe</p>
          </div>
