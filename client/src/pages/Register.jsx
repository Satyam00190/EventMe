...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-8 sm:py-12 px-4 sm:px-6">
      {/* Animated Background */}
      ...
      <div className="max-w-md w-full relative z-10 animate-fade-in">
        <div className="glass-dark rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 border border-white/20">
          {/* Logo/Header */}
          <div className="text-center mb-6 sm:mb-8">
            <div className="gradient-secondary w-16 h-16 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-3 sm:mb-4 shadow-lg">
              <FaUserPlus className="text-white text-2xl sm:text-3xl" />
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-[#5A43FF] via-purple-500 to-[#FF8F00] bg-clip-text text-transparent animate-gradient">
              Create Account
            </h2>
            <p className="text-white text-base sm:text-lg font-medium">Join EventMe and start your journey</p>
          </div>
          ...
          {success && (
            <div className="bg-green-50 border-l-4 border-green-500 text-green-700 px-4 py-3 rounded-xl mb-6 animate-slide-up">
              <p className="font-medium">✅ Account created & logged in successfully!</p>
              <p className="text-sm mt-1">Redirecting you to {formData.role === 'organizer' ? 'your events dashboard' : 'browse events'}...</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              {formData.password && (
                <div className="mt-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs font-bold ${passwordStrength < 40 ? 'text-red-400' : passwordStrength < 70 ? 'text-yellow-400' : 'text-green-400'}`}>
              ...
              <p className="text-xs text-gray-300 mt-2 font-medium">✓ Use 8+ characters with mix of letters, numbers & symbols</p>
            </div>
